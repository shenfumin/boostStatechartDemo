...
#ifndef FooSupport_982569605_h
#define FooSupport_982569605_h
...
DDS_TYPESUPPORT_CPP(FooTypeSupport, Foo);
DDS_DATAWRITER_CPP(FooDataWriter, Foo);

DDS_DATAREADER_CPP(FooDataReader, Foo);
...
DDS_TYPESUPPORT_CPP(MyOtherTypeTypeSupport, MyOtherType);
DDS_DATAWRITER_CPP(MyOtherTypeDataWriter, MyOtherType);

DDS_DATAREADER_CPP(MyOtherTypeDataReader, MyOtherType);
